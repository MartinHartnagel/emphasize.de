...
<body onload="initLogin()">
			...
			<span style="text-align:center;padding-left:1%;padding-right:1%;white-space:nowrap;">
				<div class="hc">
					...
					<div id="help_recommend" class="docu"
						...
						l'Emphasize sur les réseaux sociaux.</fr> <es>Hacer Emphasize en
	...
	<div
		...
		<div style="position: absolute; top: 0px; left: 0px; width: 420px;">
			...
			<table id="table" class="dashboard" width="420" height="200"
				border="0" cellspacing="2" cellpadding="0">
				<tr>
					<td rowspan="2" style="background-color: #bdc406;"><i18n ref="con5"></i18n>
					</td>
					<td style="background-color: #6ba163;"><i18n ref="con6"></i18n></td>
				</tr>
				<td style="background-color: #a16363;"><i18n ref="con7"></i18n></td>
				</tr>
			</table>
			<!-- izip
