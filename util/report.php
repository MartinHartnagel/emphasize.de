...
if (isset($export) && $export=="csv") {
	...
	header("Content-disposition: attachment; filename=" . $name."-".$report_name."_".date("Y-m-d").".csv");
	echo("#".$name." ".$reports[$report_name]." ".$from_date."&nbsp;<i18n ref='rpb0'></i18n>&nbsp;".$to_date."&nbsp;<i18n ref='rpb1'></i18n>&nbsp;" . $time."\n");
} else if (isset($export) && $export=="xml") {
	header('Content-Type: text/xml;charset=UTF-8');
	header("Content-disposition: attachment; filename=" . $name."-".$report_name."_".date("Y-m-d").".xml");
	echo('<?xml version="1.0" encoding="UTF-8"?>');
	echo("\n<report title=\"".$name." ".$reports[$report_name]." ".$from_date."&nbsp;<i18n ref='rpb0'></i18n>&nbsp;".$to_date."&nbsp;<i18n ref='rpb1'></i18n>&nbsp;".$time."\">\n");
} else {
	echo("<title>".$name." ".$reports[$report_name]." ".$from_date."&nbsp;<i18n key='rpb0'><en>to</en><de>bis</de><fr>-</fr><es>-</es></i18n>&nbsp;".$to_date."&nbsp;<i18n key='rpb1'><en>at</en><de>um</de><fr>à</fr><es>a</es></i18n>&nbsp;" . $time."</title>"); ?>
</head>
<body onload="initReport()">
	<h1>
		<?php echo($name." ".$reports[$report_name]); ?>
	</h1>
	<?php echo($from_date."&nbsp;<i18n ref='rpb0'></i18n>&nbsp;".$to_date); ?>&nbsp;<i18n ref="rpb1"></i18n>&nbsp;<?php echo($time); ?>
