...
foreach($deleteIds as $id) {
  $delete = @mysql_query("DELETE FROM " . $db_prefix . "USAGE WHERE id=".$id);
	if (!$delete) {
		echo("delete failed: "."DELETE FROM " . $db_prefix . "USAGE WHERE id=".$id."\n");
	}
  $delete = @mysql_query("DELETE FROM " . $db_prefix . "ENTRY WHERE id=".$id);
	if (!$delete) {
		echo("delete failed: "."DELETE FROM " . $db_prefix . "ENTRY WHERE id=".$id."\n");
	}
  $delete = @mysql_query("DELETE FROM " . $db_prefix . "INFO WHERE id=".$id);
	if (!$delete) {
		echo("delete failed: "."DELETE FROM " . $db_prefix . "INFO WHERE id=".$id."\n");
	}
  $delete = @mysql_query("DELETE FROM " . $db_prefix . "TEMPLATES WHERE id=".$id);
	if (!$delete) {
		echo("delete failed: "."DELETE FROM " . $db_prefix . "TEMPLATES WHERE id=".$id."\n");
	}
  $delete = @mysql_query("DELETE FROM " . $db_prefix . "CRON WHERE id=".$id);
	if (!$delete) {
		echo("delete failed: "."DELETE FROM " . $db_prefix . "CRON WHERE id=".$id."\n");
	}
