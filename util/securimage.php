 ...
 */
 ...
 function Securimage()
 {
  ...
  $this->image_bg_color = new Securimage_Color("#ff0000");
  $this->multi_text_color = array(new Securimage_Color("#ff8400"),
    new Securimage_Color("#18bf13"),
    new Securimage_Color("#4035d5"),
    new Securimage_Color("#d20005"),
    new Securimage_Color("#a621ae"),
    new Securimage_Color("#fbed15")
  );
  $this->use_multi_text = true;
  $this->text_angle_minimum = -5;
  $this->text_angle_maximum = 5;
  $this->use_transparent_text = true;
  $this->text_transparency_percentage = 20; // 100 = completely transparent
  $this->num_lines = 4;
  $this->line_color = new Securimage_Color("#eaeaea");
  $this->image_signature = '';
  $this->signature_color = new Securimage_Color(rand(0, 64), rand(64, 128), rand(128, 255));
 ...
 function allocateColors()
 {
  ...
  $this->gdbgcolor = imagecolorallocatealpha($this->im, 127,127, 127, 127);
 ...
 function setBackground()
 {
  ...
  imagealphablending($this->tmpimg, false);
